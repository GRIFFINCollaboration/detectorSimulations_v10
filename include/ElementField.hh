...
//  class ElementField - interface for the EM field of one element
...
class ElementField
{
  ...
  public:
    ...
    /// the actual implementation constructs the ElementField
    void construct();

    ///  Destructor.
    virtual ~ElementField() { if (aNavigator) delete aNavigator; }
...
//    ElementField(const ElementField&);
